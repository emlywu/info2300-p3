...
?>
  ...
  <form class="login-form" action="<?php echo htmlspecialchars($action) ?>" method="post" novalidate>

    <label class="login-lbl" for="username">Username:</label>
    <input id="username" type="text" name="login_username" value="<?php echo htmlspecialchars($sticky_login_username); ?>" required /><br />

    <label class="login-lbl" for="password">Password:</label>
    <input id="password" type="password" name="login_password" required /><br />

    <button class="btn this" name="login" type="submit">Sign In</button>
  </form>
<?php
}
