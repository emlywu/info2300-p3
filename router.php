...
if (preg_match('/^\/public\//', $request_uri)) {
  ...
  return False;
} else if (match_routes($request_uri, ['/', '/home', '/explore'])) {
  require 'pages/home.php';
} else if (match_routes($request_uri, '/contribute')) {
  require 'pages/contribute.php';
} else if (match_routes($request_uri, '/login')) {
  require 'pages/login.php';
} else if (match_routes($request_uri, '/explore/view')) {
